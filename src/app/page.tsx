...
import { 
  LogIn, Menu, Leaf, FlaskConical, BookOpen, 
...
const featureCards = [
  ...
  {
    icon: <BookOpen className="w-10 h-10 text-teal-600" />,
    title: "Edukasi",
    ...
    <header id='header' className={headerClasses}>
      <div className="container md:px-20 mx-auto px-6 py-4 flex justify-between items-center">
        <a href="#" className="text-2xl font-bold flex items-center gap-2">
          <Image src="/images/logo-gp.png" alt="logo green pyramid" width={50} height={50} />
        ...
        <nav className="hidden lg:flex items-center space-x-8">
          {navLinks.map((link) => (
            <a key={link.href} href={link.href} className={`transition duration-300 py-2 relative ${
              ...
              {link.label}
              {activeSection === link.href.substring(1) && (
                <span className="absolute left-1/2 -bottom-1 h-[2px] w-3/5 -translate-x-1/2 rounded-full bg-teal-700"></span>
              )}
            </a>
          ))}
        </nav>
        <div className="flex items-center gap-4">
          <a href="#login" className="hidden lg:flex bg-teal-500 text-white px-5 py-2.5 rounded-lg font-semibold hover:bg-teal-600 transition duration-300 shadow-md items-center gap-2">
      ...
      {/* Mobile Menu */}
      {isMenuOpen && (
        <div className="lg:hidden g-white/95 backdrop-blur-md bg-white px-6 pb-4">
          {navLinks.map((link) => (
            <a key={link.href} href={link.href} className="block py-2 text-gray-600 hover:text-green-700" onClick={() => setIsMenuOpen(false)}>{link.label}</a>
          ))}
          <a href="#login" className="lg:hidden flex bg-teal-500 text-white px-5 py-2.5 my-2 rounded-lg font-semibold hover:bg-teal-600 transition duration-300 shadow-md items-center gap-2">
            <LogIn className="w-4 h-4" />
            <span>Login</span>
          </a>
        </div>
  ...
  return (
    <div className='bg-gray-50 text-gray-800'>
      ...
      <main className=''>
        ...
        {/* Hero Section */}
        <section id='hero' className='min-h-screen bg-gradient-to-b from-teal-50 to-gray-50 flex items-center'>
          <div className='container md:px-28 mx-auto px-6 grid md:grid-cols-2 gap-10 items-center pt-24 md:pt-0'>
            {/* Left Column: Text Content */}
            <div className="text-center md:text-left">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-teal-600 leading-tight">
                <TextAnimate animation="blurInUp" by="word" once>
                  Green Pyramid, Lab Inovasi Hijau
                </TextAnimate>
              </h1>
              <p className="mt-6 text-lg text-gray-600 max-w-lg mx-auto md:mx-0">
                Tempat Berfotosintesis di Jantung Kampus Kita. Jelajahi kolaborasi antara teknologi modern dan keanekaragaman hayati di pusat riset kami.
              </p>
              <div className="mt-10 flex justify-center md:justify-start items-center gap-4">
                <a href="#koleksi" className="bg-teal-500 text-white px-7 py-3 rounded-lg font-bold hover:bg-teal-600 transition duration-300 shadow-lg flex items-center gap-2">
                  Mulai Menjelajah
                </a>
              </div>
            </div>
            ...
            <div className="relative h-full flex justify-center items-center">
              <svg className="absolute w-sm h-full text-teal-100 opacity-70 -z-0" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="absolute top-10 right-5 text-teal-200 -z-0" style={{ fontSize: '3rem', lineHeight: 0.5 }}>...<br/>...<br/>...<br/>...</div>
            </div>
          </div>
        </section>
        ...
        <section id='tentang' className='py-20'>
          <div className='container md:px-28 mx-auto px-6'>
            <div className='text-center mb-12'>
              ...
              <p className='mt-4 max-w-2xl mx-auto text-gray-600'>Green Pyramid adalah pusat riset, konservasi, dan pembelajaran di mana mahasiswa dan peneliti berkolaborasi untuk mengembangkan solusi pertanian cerdas.</p>
            </div>
          ...
          <div className='container md:px-28 mx-auto px-6'>
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="text-center md:text-left" data-aos="fade-right">
                ...
                <Link href="/dashboard/smartdec" id="login" className="mt-8 mx-auto md:mx-0 bg-teal-500 text-white px-8 py-3 rounded-lg font-semibold hover:bg-teal-600 transition duration-300 shadow-lg flex items-center gap-2 w-fit">
          ...
          <div className="container md:px-28 mx-auto px-6 text-center">
            ...
            <div className="mt-12 grid md:grid-cols-3 gap-8 text-left">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md" data-aos="flip-down">
                ...
                <p className="text-gray-600">Untuk riset & kolaborasi:<br /><a href="https://api.whatsapp.com/send?phone=6281575777564" className="text-teal-600 hover:underline">+62 815-7577-7564</a></p>
              </div>
            </div>
